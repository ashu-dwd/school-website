...
if (isset($_POST['btn'])) {
    if (isset($_FILES['img']) && $_FILES['img']['error'] == 0) {
        ...
        $check_sql = "SELECT * FROM `problems` WHERE `img` = '$file_name' AND `s_id` = '$id'";
            ...
            if (move_uploaded_file($_FILES['img']['tmp_name'], $path)) {
                ...
                if ($res) {
                    echo '<div class="container"><div class="alert alert-success alert-dismissible fade show" role="alert">
                            ...
                            <strong>Uploaded!</strong> Your ' . $subject . ' doubt has been uploaded successfully.<a href="../home.php" class="alert-link">Move To Home Page</a>
                          </div></div>';
                } else {
                    echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                            <strong>Error!</strong> There was a problem uploading your ' . $subject . ' doubt. Please try again.
                          </div>';
                }
            } else {
                echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
...
<head>
    <title>Upload Your Doubts</title>
    <meta charset="utf-8" />
    ...
    <main>
        <div class="container mt-4">
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="img" class="form-label">Upload Doubt Image:</label>
